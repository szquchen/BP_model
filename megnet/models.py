...
from megnet.layers.graph.megnet import MEGNetLayer
from megnet.layers.readout.set2set import Set2Set
...
def make_megnet_model(nfeat_edge=None, nfeat_global=None, nfeat_node=None, nblocks=3,
                      ...
                      npass=3, ntarget=1, act=softplus2, final_act=None, is_classification=False,
